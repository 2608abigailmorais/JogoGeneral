...
<body>
    <h2 class="card-panel #b38600" style = "color: #190710"> <center class="bubble">Jogo do General</center></h2>
        <div class="container">
    
    <div class="row mb-3">
        <form method="get" action="">
        
        <label for="jogador" class="col-sm-2 col-form-label"> Diga-me seu nome, grande jogador. Vamos começar a jogar logo. </label>
        <input type="text" class="form-control" name="jogador" id="jogador" placeholder="Insira o nome do jogador" value="<?php echo "$jogador";?>" />
<br><br>
        <center><input class="btn btn-dark" type="submit" value="Role os dados!"></center>
</form> 
    </div>
        <hr>
        <?php
